...
LOG_FILE="/var/log/lego/com.lego.de.wallpapersetup-$CURRENT_DATETIME.log"
...
BASE64_FILE_PATH="/var/log/lego/output/base64_output.txt"
...
PROFILE_PATH="$HOME/Desktop/com.lego.de.desktop.profile.plist"
...
<dict>
    ...
    <array>
        <dict>
            ...
            <string>com.lego.de.mydesktoppayload</string>
            <key>PayloadType</key>
    ...
    <key>PayloadIdentifier</key>
    <string>com.lego.de.desktop.profile</string>
    <key>PayloadType</key>
...
# Exit Codes:
# 0 - Success
# 1 - Duplicate images found, process halted
# 2 - Failed to create log file
# 3 - Failed to create target directory
# 4 - Base64 file not found at specified path
# 5 - Duplicate image detected based on checksum comparison, exiting
# 6 - Failed to decode and save image or image is empty
